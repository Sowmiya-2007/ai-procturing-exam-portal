        ...
        for st in students:
            ...
            enrolled_list.append(
                EnrolledStudentResponse(
                    ...
                    exam_title_en=getattr(ex, "title_en", None) or ex.title,
                    exam_title_ta=getattr(ex, "title_ta", None),
                    exam_title_te=getattr(ex, "title_te", None),
                    exam_title_hi=getattr(ex, "title_hi", None),
                    exam_title_ml=getattr(ex, "title_ml", None),
                    exam_title_kn=getattr(ex, "title_kn", None),
                    exam_subject_en=getattr(ex, "subject_en", None) or ex.subject,
                    exam_subject_ta=getattr(ex, "subject_ta", None),
                    exam_subject_te=getattr(ex, "subject_te", None),
                    exam_subject_hi=getattr(ex, "subject_hi", None),
                    exam_subject_ml=getattr(ex, "subject_ml", None),
                    exam_subject_kn=getattr(ex, "subject_kn", None),
