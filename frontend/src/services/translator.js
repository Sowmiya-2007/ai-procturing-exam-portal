...
/**
 * Format question prefix (e.g. "Q1" -> "கேள்வி 1", "ప్రశ్న 1", "प्रश्न 1", "ചോദ്യം 1", "ಪ್ರಶ್ನೆ 1")
 */
export function formatQuestionPrefix(num, lang = "en") {
  switch (lang) {
    case "ta":
      return `கேள்வி ${num}`;
    case "te":
...
export const TRANSLATION_MAP = {
  ...
  "Comprehensive Midterm 2026": {
    ta: "விரிவான இடைப்பருவத் தேர்வு 2026",
    te: "సమగ్ర మిడ్-టర్మ్ పరీక్ష 2026",
    hi: "व्यापक मध्यावधि परीक्षा 2026",
    ml: "സമഗ്ര മിഡ്-ടേം പരീക്ഷ 2026",
    kn: "ಸಮಗ್ರ ಮಿಡ್-ಟರ್ಮ್ ಪರೀಕ್ಷೆ 2026"
  },
  "Draft Exam Blueprint": {
    ta: "வரைவு தேர்வு வரைபடம்",
    te: "డ్రాఫ్ట్ పరీక్ష బ్లూప్రింట్",
    hi: "प्रारूप परीक्षा खाका",
    ml: "ഡ്രാഫ്റ്റ് പരീക്ഷാ ബ്ലൂപ്രിന്റ്",
    kn: "ಕರಡು ಪರೀಕ್ಷೆಯ ನೀಲನಕ್ಷೆ"
  },
  "Toggle Status Exam": {
    ta: "நிலை மாற்றுத் தேர்வு",
    te: "స్థితి మార్పిడి పరీక్ష",
    hi: "स्थिति टॉगल परीक्षा",
    ml: "സ്റ്റാറ്റസ് ടോഗിൾ പരീക്ഷ",
    kn: "ಸ್ಥಿತಿ ಟಾಗಲ್ ಪರೀಕ್ಷೆ"
  },
  ...
  "Operating Systems": {
    ta: "இயக்க முறைமைகள்",
    te: "ఆపరేటింగ్ సిస్టమ్స్",
    hi: "ऑपरेटिंग सिस्टम",
    ml: "ഓപ്പറേറ്റിംഗ് സിസ്റ്റംസ്",
    kn: "ಆಪರೇಟಿಂಗ್ ಸಿಸ್ಟಮ್ಸ್"
  },
  "Computer Organization": {
    ta: "கணினி அமைப்பு",
    te: "కంప్యూటర్ ఆర్గనైజేషన్",
    hi: "कंप्यूटर संगठन",
    ml: "കമ്പ്യൂട്ടർ ഓർഗനൈസേഷൻ",
    kn: "ಕಂಪ್ಯೂಟರ್ ಸಂಸ್ಥೆ"
  },
  "Object Oriented Programming": {
    ...
    ml: "ഒബ്ജക്റ്റ് ഓറിയന്റഡ് പ്രോഗ്രാമിംഗ്",
    kn: "ಆಬ್ಜೆಕ್ಟ್ ಓರಿಯೆಂಟೆಡ್ ಪ್ರೋಗ್ರಾಮಿಂಗ್"
  },
  "Cybersecurity & Networks": {
    ta: "இணையப் பாதுகாப்பு மற்றும் நெட்வொர்க்குகள்",
    te: "సైబర్‌ సెక్యూరిటీ & నెట్‌వర్క్‌లు",
    hi: "साइबर सुरक्षा और नेटवर्क",
    ml: "സൈബർ സുരക്ഷ & നെറ്റ്‌വർക്കുകൾ",
    kn: "ಸೈಬರ್ ಭದ್ರತೆ ಮತ್ತು ನೆಟ್‌ವರ್ಕ್‌ಗಳು"
  },
  "Data Structures & Algorithms": {
    ta: "தரவு கட்டமைப்புகள் மற்றும் அல்காரிதம்கள்",
    te: "డేటా స్ట్రక్చర్స్ & అల్గారిథమ్స్",
    hi: "डेटा संरचनाएं और एल्गोरिदम",
    ml: "ഡാറ്റാ ഘടനകളും അൽഗോരിതങ്ങളും",
    kn: "ಡೇಟಾ ರಚನೆಗಳು ಮತ್ತು ಅಲ್ಗಾರಿದಮ್‌ಗಳು"
  },
  "Database Systems": {
    ta: "தரவுத்தள அமைப்புகள்",
    te: "డేటాబేస్ సిస్టమ్స్",
    hi: "डेटाबेस सिस्टम",
    ml: "ഡാറ്റാബേസ് സിസ്റ്റംസ്",
    kn: "ಡೇಟಾಬೇಸ್ ಸಿಸ್ಟಮ್ಸ್"
  },
